...
import './PersonalReasonsSurvey.scss';
...
const PersonalReasonsSurvey = (props) => {
  ...
  const error = (event) => {
    ...
    const message = {
      notifStatus: true,
      notifMessage: "Answer all the Personal Related Questions first before continue on the next Survey"
    }
  ...
  return (
    <div className='personalReasonSurvey'>
      <div className='personalReasonSurveyContent'>
...
export default PersonalReasonsSurvey;
