...
import './ClientRelatedSurvey.scss';
...
const ClientRelatedSurvey = (props) => {
  ...
  const error = (event) => {
    ...
    const message = {
      notifStatus: true,
      notifMessage: "Answer all the Client Related Questions first before continue on the next Survey"
    }
  ...
  return (
    <div className="clientRelatedSurvey">
        <div className="clientRelatedSurveyContent">
...
export default ClientRelatedSurvey
